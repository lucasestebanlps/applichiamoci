      ...
      child: ListView(
        ...
        children: [
          UserAccountsDrawerHeader(
            ...
            accountName: Text('Lucas Esteban', style: Theme.of(context).textTheme.headlineSmall,), 
            accountEmail: Text('lucasestebanlps@gmail.com', style: Theme.of(context).textTheme.bodyMedium),
