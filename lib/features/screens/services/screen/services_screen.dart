...
import 'package:applichiamoci/features/screens/services/screen/widgets/services_card.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Obx(() {
          // Si todavia no cargaron los servicios muestra el shimmer personalizado
          if (serviceController.isLoading.value) {
            return const LServiceShimmer(itemCount: 8);
          }
          // Cuando los servicios estan cargados genera la grid de servicios
          return GridView.builder(
            ...
            itemBuilder: (_, index) {
              ...
              return LServicesCard(service: service);
            },
          );
        }),
      ),
