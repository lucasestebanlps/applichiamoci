...
class LTextFormFieldTheme {
  ...
  static InputDecorationTheme lightInputDecorationTheme = InputDecorationTheme(
    ...
    labelStyle: const TextStyle().copyWith(fontSize: LSizes.fontSizeMd, color: LColors.black),
    hintStyle: const TextStyle().copyWith(fontSize: LSizes.fontSizeSm, color: LColors.black),
    errorStyle: const TextStyle().copyWith(fontStyle: FontStyle.normal),
    floatingLabelStyle: const TextStyle().copyWith(color: LColors.black.withOpacity(0.8)),
  ...
  static InputDecorationTheme darkInputDecorationTheme = InputDecorationTheme(
    ...
    suffixIconColor: LColors.darkGrey,
    // constraints: const BoxConstraints.expand(height: TSizes.inputFieldHeight),
    labelStyle: const TextStyle().copyWith(fontSize: LSizes.fontSizeMd, color: LColors.white),
    hintStyle: const TextStyle().copyWith(fontSize: LSizes.fontSizeSm, color: LColors.white),
    floatingLabelStyle: const TextStyle().copyWith(color: LColors.white.withOpacity(0.8)),
    border: const OutlineInputBorder().copyWith(
      borderRadius: BorderRadius.circular(LSizes.inputFieldRadius),
