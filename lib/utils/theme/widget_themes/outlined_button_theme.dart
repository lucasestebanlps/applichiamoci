...
class LOutlinedButtonTheme {
  ...
  static final lightOutlinedButtonTheme  = OutlinedButtonThemeData(
    style: OutlinedButton.styleFrom(
      ...
      textStyle: const TextStyle(fontSize: 16, color: LColors.black, fontWeight: FontWeight.w600),
      padding: const EdgeInsets.symmetric(vertical: LSizes.buttonHeight, horizontal: 20),
